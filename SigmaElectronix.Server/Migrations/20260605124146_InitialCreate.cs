        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "numeric(11,8)", precision: 11, scale: 8, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredStoreId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Stores_PreferredStoreId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ShippingPhone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ShippingEmail = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminResponseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PreferredStoreId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreInventories_StoreId_ProductId",
                table: "StoreInventories",
