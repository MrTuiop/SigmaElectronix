...
- Создайте проект Angular с помощью ng: `ng new sigmaelectronix.client --defaults --skip-install --skip-git --no-standalone `.
...
- Создание файла проекта (`sigmaelectronix.client.esproj`).
